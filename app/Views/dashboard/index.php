  ...
  <div class="dash-grid">
    ...
    <div class="dash-sidebar">
      <div class="profile-card">
        ...
        <span class="badge badge-<?= Validator::e($user['subscription_plan']) ?>"><?= ucfirst(Validator::e($user['subscription_plan'])) ?> Plan</span>
      </div>

      <?php
        $swapsDone = count(array_filter($mySwaps, fn($s) => $s['status'] === 'completed'));
        $activeSwaps = count(array_filter($mySwaps, fn($s) => in_array($s['status'], ['requested','accepted','in_progress'])));
      ?>
